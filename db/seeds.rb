...
lecture = Lecture.new(title: "intro", content: "In this course, you will learn the different types of plastic you can recycle",learning_id: learninga.id)
lecture.save!
puts "lecture added to learning"

puts "Adding a lesson in lecture 2 1/7"
lecture = Lecture.new(title: "Polyethylene Terephthalate", content: "<h3>Polyethylene Terephthalate (PET)</h3>
...
lecture = Lecture.new(title: "Polyethylene de haute densité", content: "<h3>Polyethylene de haute densité (PEH)</h3>
...
lecture = Lecture.new(title: "Polyvinyl Chloride", content: "<h3>Polyvinyl Chloride (PVC)</h3>
...
lecture = Lecture.new(title: "Low Density Polyethylene (LDPE)", content: "  <h3>Low Density Polyethylene (LDPE)</h3>
...
lecture = Lecture.new(title: "Polypropylene", content: "  <h3>Polypropylene (PP)</h3>
...
lecture = Lecture.new(title: "Polystyrene", content: "  <h3>Polystyrene (PS)</h3>
...
lecture = Lecture.new(title: "Les autres platiques", content: "  <h3>Les autres plastiques </h3>
...
quiz = Question.new(content: "Le PVC est un plastique", learning_id: learninga.id)
quiz.save!
puts "question saved"
...
quiz = Question.new(content: "On différencie le PET et le PEH grâce à", learning_id: learninga.id)
quiz.save!
puts "question saved"
...
quiz = Question.new(content: "Il existe", learning_id: learninga.id)
quiz.save!
puts "question saved"
...
quiz = Question.new(content: "Pour les sachets de pains ou les sacs de nourriture surgelés, est utilisé principalement", learning_id: learninga.id)
quiz.save!
puts "question saved"
...
quiz = Question.new(content: "Le plastique le plus recyclé au monde et donc le plus safe à acheté, c'est", learning_id: learninga.id)
quiz.save!
puts "question saved"
...
puts "making question"
quiz = Question.new(content: "Le plastique le moins recyclé au monde, et donc le plus nocif, c'est", learning_id: learninga.id)
quiz.save!
puts "question saved"
